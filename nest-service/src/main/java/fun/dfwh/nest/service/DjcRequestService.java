...
import fun.dfwh.nest.constant.SignRuleId;
import fun.dfwh.nest.dao.DjcAppProperties;
import fun.dfwh.nest.entity.Phone;
import fun.dfwh.nest.pojo.DjcResult;
import fun.dfwh.nest.utils.DjcSignUtil;
import fun.dfwh.nest.utils.DjcTokenUtil;
